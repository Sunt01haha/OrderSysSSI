		...
		<form name=alipayment action='alipay/alipay.trade.page.pay.jsp' method=post
			...
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					...
					<dt>付款金额 ：</dt>
					<dd>
						<input id="WIDtotal_amount" name="WIDtotal_amount" value="${param.price}"/>
...
<script language="javascript">
	...
	function GetDateNow() {
		...
		document.getElementById("WIDsubject").value = "餐饮结账";
		document.getElementById("WIDtotal_amount").value = "${requestScope.sum}";
		document.getElementById("WIDbody").value = "xx餐饮的消费为${requestScope.sum}，请及时付款";
	}
	GetDateNow();
</script>
</html>