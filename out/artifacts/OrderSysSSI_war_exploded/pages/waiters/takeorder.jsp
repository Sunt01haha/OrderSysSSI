...
<script type="text/javascript">
	...
	function setTableId() {
		...
		alert("桌号设置成功");
		window.location.href = 'towaitermain.order?tableId=' + id.value;
	}
	...
	<div class="container-fluid">
		...
		<div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-right">
				<li><span class="navbar-brand">&nbsp;&nbsp;&nbsp;&nbsp;当前桌号为<span id="tableresult">( ${param.tableId} )号桌&nbsp;&nbsp;&nbsp;&nbsp;</span></span></li>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<ol class="breadcrumb">
					<li><a href="/OrderSysSSI_war_exploded/towaitermain.order">首页</a></li>
					<li>服务员</li>
