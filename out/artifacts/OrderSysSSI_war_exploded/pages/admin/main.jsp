...
<script type="text/javascript">
	...
	// function pay(obj, orderId , sumPrice) {
	//
	// 	if (confirm("确认收到买单款项？")) {
	//
	// 		txtAjaxRequest("changeorder.order?orderId=" + orderId
	...
	//
	// 	}else {
	// 		// txtAjaxRequest("alipay.order?orderId=" + orderId);
	// 		window.location.href = 'alipay.order?orderId='+orderId;
	// 	}
	// }
	// function pay(obj, orderId , sumPrice) {
	//
	...
	function pay(obj, orderId , sumPrice) {
		...
		if (confirm("请使用支付宝付款！")) {
			window.location.href = 'alipay/indexalipay.jsp?orderId=' + sumPrice;
		}
	}
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<ol class="breadcrumb">
					<li><a href="/OrderSysSSI_war_exploded/toadminmain.order">首页</a></li>
					<li>管理员</li>
